...
const ALL_COLUMNS: SupplierColumnDef[] = [
  ...
  { key: 'avenants', label: 'Avenants', defaultVisible: false, render: (s) => s.avenants || '—' },
  { key: 'evolution_tarif_2026', label: 'Évolution tarif 2026', defaultVisible: false, render: (s) => s.evolution_tarif_2026 || '—' },
  { key: 'echeances_de_paiement', label: 'Échéances paiement', defaultVisible: false, render: (s) => s.echeances_de_paiement || '—' },
  { key: 'delai_de_paiement', label: 'Délai paiement', defaultVisible: false, render: (s) => s.delai_de_paiement || '—' },
  { key: 'penalites', label: 'Pénalités', defaultVisible: false, render: (s) => s.penalites || '—' },
  { key: 'exclusivite_non_sollicitation', label: 'Exclusivité', defaultVisible: false, render: (s) => s.exclusivite_non_sollicitation || '—' },
  { key: 'remise', label: 'Remise', defaultVisible: false, render: (s) => s.remise || '—' },
  ...
  { key: 'garanties_bancaire_et_equipement', label: 'Garanties', defaultVisible: false, render: (s) => s.garanties_bancaire_et_equipement || '—' },
